...
const DatabaseWithRestApi = ({
  ...
  return (
    <div className={cn("relative flex h-[400px] w-full max-w-[600px] flex-col items-center", className)}>
      {/* SVG Paths */}
      <svg className="h-full sm:w-full text-muted" width="100%" height="100%" viewBox="0 0 200 100">
        <g stroke="currentColor" fill="none" strokeWidth="0.4" strokeDasharray="100 100" pathLength="100">
          <path d="M 38 10 v 15 q 0 5 5 5 h 52 q 5 0 5 5 v 10" />
          <path d="M 77 10 v 10 q 0 5 5 5 h 13 q 5 0 5 5 v 10" />
          <path d="M 124 10 v 10 q 0 5 -5 5 h -14 q -5 0 -5 5 v 10" />
          <path d="M 163 10 v 15 q 0 5 -5 5 h -53 q -5 0 -5 5 v 10" />
        ...
        <g stroke="currentColor" fill="none" strokeWidth="0.4">
          {/* First Button */}
          <g>
            <rect fill="#18181B" x="21" y="5" width="35" height="10.2" rx="5"></rect>
            <text x="38.5" y="11.5" fill="white" stroke="none" fontSize="4.5" fontWeight="500" textAnchor="middle">
          ...
          <g>
            ...
            <text x="77" y="11.5" fill="white" stroke="none" fontSize="4.5" fontWeight="500" textAnchor="middle">
              {badgeTexts?.second || "POST"}
            </text>
          </g>
          {/* Third Button */}
          <g>
            <rect fill="#18181B" x="107" y="5" width="34" height="10" rx="5"></rect>
            <text x="124" y="11.5" fill="white" stroke="none" fontSize="4.5" fontWeight="500" textAnchor="middle">
              {badgeTexts?.third || "PUT"}
            </text>
          </g>
          {/* Fourth Button */}
          <g>
            <rect fill="#18181B" x="146" y="5" width="34" height="10" rx="5"></rect>
            <text x="163" y="11.5" fill="white" stroke="none" fontSize="4.5" fontWeight="500" textAnchor="middle">
        ...
        <defs>
          {/* 1 - donations */}
          <mask id="db-mask-1">
            <path d="M 38 10 v 15 q 0 5 5 5 h 52 q 5 0 5 5 v 10" strokeWidth="0.5" stroke="white" />
          </mask>
          {/* 2 - expenses */}
          <mask id="db-mask-2">
          ...
          {/* 4 - members */}
          <mask id="db-mask-4">
            <path d="M 163 10 v 15 q 0 5 -5 5 h -53 q -5 0 -5 5 v 10" strokeWidth="0.5" stroke="white" />
          </mask>
          {/* Blue Grad */}
