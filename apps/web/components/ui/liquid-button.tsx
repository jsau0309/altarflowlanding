      ...
      >
        <div
          className="absolute top-0 left-0 z-0 h-full w-full rounded-full 
            shadow-[0_0_6px_rgba(59,130,246,0.08),0_2px_6px_rgba(59,130,246,0.12),inset_3px_3px_0.5px_-3px_rgba(59,130,246,0.3),inset_-3px_-3px_0.5px_-3px_rgba(59,130,246,0.25),inset_1px_1px_1px_-0.5px_rgba(59,130,246,0.4),inset_-1px_-1px_1px_-0.5px_rgba(59,130,246,0.4),inset_0_0_6px_6px_rgba(59,130,246,0.08),inset_0_0_2px_2px_rgba(59,130,246,0.04),0_0_12px_rgba(59,130,246,0.2)] 
        transition-all 
        dark:shadow-[0_0_8px_rgba(59,130,246,0.08),0_2px_6px_rgba(59,130,246,0.12),inset_3px_3px_0.5px_-3.5px_rgba(147,197,253,0.15),inset_-3px_-3px_0.5px_-3.5px_rgba(147,197,253,0.25),inset_1px_1px_1px_-0.5px_rgba(147,197,253,0.4),inset_-1px_-1px_1px_-0.5px_rgba(147,197,253,0.4),inset_0_0_6px_6px_rgba(59,130,246,0.08),inset_0_0_2px_2px_rgba(59,130,246,0.04),0_0_12px_rgba(59,130,246,0.2)]"
        />
        <div
          className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-md bg-blue-50/30"
